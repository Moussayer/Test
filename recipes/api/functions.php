	...
	public function getAds() {
		...
		if (isset($_GET['api_key'])) {
			...
			if ($access_key_received == $api_key) {			
				...
				$query = "SELECT a.ad_status, a.ad_type, a.admob_publisher_id, a.admob_app_id, a.admob_banner_unit_id, a.admob_interstitial_unit_id, a.admob_native_unit_id, a.fan_banner_unit_id, a.fan_interstitial_unit_id, a.fan_native_unit_id, a.startapp_app_id, a.interstitial_ad_interval, a.native_ad_interval, a.native_ad_index, a.date_time, s.youtube_api_key FROM tbl_ads a, tbl_settings s WHERE a.id = 1 AND s.id = 1";
