                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <ol>
                                ...
                                <li>Copy API key and paste it in the admin panel youtube api key settings form.<br><br><iframe width="100%" height="420px" src="https://www.youtube.com/embed/eAkyaEHMJUE">
</iframe></li>
                            </ol>
                        </div>
                        <div class="modal-footer">
