                ...
                <a href="manage-featured.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="color-name"><?php echo $total_featured; ?></div>
                            <div class="color-class-name"><?php echo $total_featured_recipes; ?></div>
                            <br>
                        </div>
                    </div>
                </a>
                ...
                <a href="manage-category.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="color-class-name"><?php echo $total_categories; ?></div>
                            <br>
                        </div>
                    </div>
                </a>
               ...
               <a href="manage-recipe.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="color-name"><?php echo $total_recipes; ?></div>
                            <div class="color-class-name"><?php echo $total_recipe; ?></div>
                            <br>
                        </div>
                    </div>
                </a>
                ...
                <a href="push-notification.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="color-class-name"><?php echo $total_templates; ?></div>
                            <br>
                        </div>
                    </div>
                </a>
